...
{
    // Vérifie si l'application tourne déjà avec le délestage NVIDIA
    ...
    if (!isPrimeSet || !isVendorSet) {
        ...
        // Récupère le chemin de l'exécutable et les arguments
        ...
        // Prépare le nouvel environnement
        ...
        // Redirige la sortie standard et d'erreur vers la console actuelle
        // Cela permet de voir les logs du processus enfant
        ...
        // Attend que l'application enfant se termine
